...
def build_geometry(unit_layout_mm=None):
    ...
    for unit_id, alpha in enumerate(angles_rad):
        center = np.asarray([radius_m * math.sin(alpha), 0.0, -radius_m * math.cos(alpha)])
...
def calculate_focus_params(distance_mm=2000, az_deg=0.0, el_deg=0.0, mode=MODE_OPTIMIZED_DBC_MARGIN, geometry=None, optimized_table=None):
